...
export function CarouselCard({type, title, blurb, url, isActiveCard=false}:CarouselCardProps) {
    ...
    return <a href={url} className={`shrink-0 w-full sm:aspect-[3/2] bg-gradient-to-tr from-blue-500 to-blue-900 rounded-xl flex h-fit overflow-hidden transition-opacity ${activeStyles}`}>
